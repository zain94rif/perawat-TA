...
<div class="card-body">
 ...
 <?php
    ...
    $q = 1;
    $dat = array();
    // if (mysqli_num_rows($myQry) < 1) echo 'Data Masih kosong';
    // else {
...
<?php
      ...
      if(isset($_POST['buttonPerawat'])){
          ...
          if(isset($_POST['pesannya'])){
            ...
            if($myQry){
              echo"<meta http-equiv='refresh' content='0; url=?Open=Terjadwal_User&tahun=".$tahun."&bulan=".$moon." '>";            
            }
      }
